...
import TableRefuel from "./TableRefuel";

function ToRefuelContent({refuelCandidate, states}) {
  let content;
  let load = (
  ...
  let alert;
  let tableContent = <TableRefuel refuelCandidate={{refuelCandidate}}/>;
  ...
  if (states.isLoading & !states.isNoContent) {
    ...
    alert = <Alert variant="danger">Уже в заправке или не найден</Alert>;
    content = tableContent
  } else {
    content = noContent;
  }
...
export default ToRefuelContent;
